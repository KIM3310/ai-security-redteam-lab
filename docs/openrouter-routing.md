...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `anthropic/claude-sonnet-4.6` | Private red-team scenario analysis with strict prompt-injection boundaries. |
...
OPENROUTER_HTTP_REFERER=https://ai-security-redteam-lab.pages.dev
OPENROUTER_APP_TITLE=ai-security-redteam-lab
```
