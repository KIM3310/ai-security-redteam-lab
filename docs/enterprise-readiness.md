...
- Demo, fixture, synthetic, or public-data boundaries are explicit before a security team sees outputs.
...
- Run a synthetic-data walkthrough with the security team and document the acceptance criteria.
