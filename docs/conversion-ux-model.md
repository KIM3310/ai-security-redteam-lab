# Conversion UX Model - AI Security Redteam Lab
...
| Primary buyer or user | Security teams and AI product teams shipping model-backed features. |
| Value wedge | Credential-free red-team fixtures for prompt injection, leakage, and unsafe tool pressure. |
...
| First action | Open the review guide, run or inspect Scanner tests pass, and map one buyer workflow to the pilot checklist. |
...
- Put Finding severity distribution on the pilot scorecard.
