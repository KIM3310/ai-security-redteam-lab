# Architecture Guide - AI Security Redteam Lab
...
|---|---|
| AI red-team workshop | Scope after product intake |
| Prompt-injection regression pack | Scope after product intake |
| CI safety gate setup | Scope after product intake |
