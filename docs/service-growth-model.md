# Service Growth Model - ai-security-redteam-lab
...
| Field | Decision |
|---|---|
| Service type | AI security red-team workflow |
| Primary reader or buyer | Security teams validating AI assistant risk before rollout. |
| Wedge | Scoped red-team diagnostic with clear legal and data boundaries. |
