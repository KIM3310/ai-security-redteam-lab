# Service Architecture - ai-security-redteam-lab
...
- **Lane:** AI security red-team workflow
- **Primary buyer:** Security teams validating AI assistant risk before rollout
- **First motion:** Scoped red-team diagnostic with clear legal and data boundaries

## Recommended Architecture

Static taxonomy and sample reports on GitHub Pages, private red-team runner in container or CI, secure report storage for buyer engagements.
...
- GitHub Pages
- container runner
- R2/S3 encrypted report storage
- OpenAI/provider API key with caps
- Sentry
...
- written authorization before tests
- no harmful public payload escalation
- redacted report outputs
